...
import com.corelin.library.api.config.annotation.CoreConfig;
...
public class CoreLinConfig {
    ...
    public CoreLinConfig(CoreLib coreLib, CoreLinPlugin plugin) {
        this.coreLib = coreLib;
        this.plugin = plugin;
        this.directoryFile = new File(System.getProperty("user.dir") + File.separator + "plugins" + File.separator +  plugin.getPluginName());
